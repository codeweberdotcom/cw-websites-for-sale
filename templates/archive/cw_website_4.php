<?php
/**
 * Archive: Websites For Sale — Template 4 (Horizontal Split, Dark Panel)
 */
...
<section id="content-wrapper" class="wrapper">
	<div class="container py-14 py-md-16">
		...
		<div class="cwgb-load-more-container"
			...
			<div class="col-12">
				<?php cw_wfs_include_card( get_the_ID(), 'card-4' ); ?>
			</div>
			<?php endwhile; ?>
			</div>
			<?php if ( $has_more ) : ?>
...
(function () {
	...
	function fetchFiltered() {
		...
		body.append( 'params', JSON.stringify({ post_type: 'cw_website', template: 'cw_websites_4', filters: filters }) );
